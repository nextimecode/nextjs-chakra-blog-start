...
test('if it works with simple data', () => {
  expect(convertPrismicToData({
    ...
    "url": null,
    "type": "blog_post",
    "href": "https://nextime-blog-template.prismic.io/api/v2/documents/search?ref=YQQChRAAACMAKj-t&q=%5B%5B%3Ad+%3D+at%28document.id%2C+%22YQQCVBAAACcAKj7I%22%29+%5D%5D",
    "tags": [],
...
test('if it works with complex data', () => {
  expect(convertPrismicToData({
    ...
    "url": null,
    "type": "blog_post",
    "href": "https://nextime-blog-template.prismic.io/api/v2/documents/search?ref=YQQF3RAAACMAKk8A&q=%5B%5B%3Ad+%3D+at%28document.id%2C+%22YQQCghAAACMAKj-a%22%29+%5D%5D",
    "tags": [],
